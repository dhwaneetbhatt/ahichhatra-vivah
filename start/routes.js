...
Route.get('/', ({ response }) => response.redirect('login'))
...
Route.group(() => {
  ...
  // Route.get('posts/:id/edit', 'UserController.edit')
  // Route.get('posts/:id/delete', 'UserController.delete')
  // Route.put('posts/:id', 'UserController.update')
}).middleware(['auth'])
